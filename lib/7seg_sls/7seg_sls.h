...
#include <Arduino.h>
...
#if 1 //^ Settings and variables for 7-segment indicator
	#define COMMON_CATODE // Comment if the indicator has a common anode (+)
	#define IND_AMOUNT_NUM 3 // Number of digits in the indicator
	//^ Variables
		uint8_t ind_buf[IND_AMOUNT_NUM]; // 7-segment indicator buffer
	uint8_t count_digit_num = 0; // Counter of active digit for indication
	#ifdef USE_STDPERIPH_DRIVER
...
#if 1 //^ Predefined digit and character codes for the 7-segment display
	/* Digit code in 7-segment indicator format */
	...
	#define S_A		0b10000000	// segment "A"
	#define S_B		0b01000000	// segment "B"
	#define S_C		0b00100000	// segment "C"
	#define S_D		0b00010000	// segment "D"
	#define S_E		0b00001000	// segment "E"
	#define S_F		0b00000100	// segment "F"
	#define S_G		0b00000010	// segment "G"
	#define S_Dp	0b00000001	// segment "."
	#define S_MINUS	S_G				// segment "-"
	/*
	  A
	F   B
	  G
...
//* pos - from which position it outputs (from 1 to IND_AMOUNT_NUM) (counting from right to left)
...
//* Example: IND_Output(123, 1, 1, 1, 3, 0) - outputs “12.3” without rounding.
//* Example: IND_Output(1234, 1, 1, 3, 0) - outputs “---” without rounding - error
//* Example: IND_Output(1234, 1, 1, 1, 3, 1) - outputs “124” with rounding.
...
void IND_Update(void)
{
  ...
  // if (count_for_7seg > 5) // for a 3-digit indicator (for a 4-digit indicator > 4)
  // {
  // IND_Update(); // must be called with frequency 50(60)Hz * number of digits
  // count_for_7seg = 0;
  // }
  // else
  // {
